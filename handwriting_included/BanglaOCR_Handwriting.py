...
def paint_text(text, w, h, rotate=False, ud=True, multi_fonts=False):
    ...
    # a = speckle(a)
    # imsave('file_'+str(random.randint(0,199))+'.png',a)
    return a
...
class TextImageGenerator(keras.callbacks.Callback):
    ...
    def build_word_list(self, num_words, max_string_len=None, mono_fraction=0.5):
        ...
        tmp_string_list = wg.newDataset(num_words,type_t)
...
def train(run_name, start_epoch, stop_epoch, img_w,type_t):
    ...
    # model.load_weights('weights99.h5')
...
if __name__ == '__main__':
    ...
    type_t="other"
    train(run_name, 0, 100, 564,type_t)
